...
public class Processes3 extends If {
    private static boolean e = false;
        private static ArrayList alternative = new ArrayList<String>();
    public static void processes3(List responses2) {
        int i = 1;
            ...
            if (operator2.equals("=") && numValue2 == numValue3 || operator2.equals(">") && numValue2 > numValue3 || operator2.equals("<") && numValue2 < numValue3)  { 
